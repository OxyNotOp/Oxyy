...
SUDO_USERS = list(map(int, getenv('SUDO_USERS', '1303669398').split()))
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", ''))
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "FEELINGSOP")
OXY_SUPPORT = getenv("ZAID_SUPPORT", "bestiesfortheresties")
