...
def play_markup(videoid, user_id):
    buttons= [
            ...
            [
                InlineKeyboardButton(text=f"✨ ɢʀᴏᴜᴘ", url=f"https://t.me/SECRET_xCITYY"),
                InlineKeyboardButton(text=f"📣 ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/hhhehaicu"),
            ],
            [      
...
def others_markup(videoid, user_id):
    buttons= [
            [
                InlineKeyboardButton(text="✨ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/xa_aaw"),
